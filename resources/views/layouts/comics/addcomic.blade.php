                    ...
                    <h3 class="kisatitle"><b>القصة</b></h2>
                        ...
                        <div class="m-title mb-3">
                            ...
                            <div class="form-group-info">
                                ...
                                <textarea name="whereistartcomics" required id="text-desc" rows="5" value="ddd"></textarea>
                                <p class="counter" id="result"></p>
                        ...
                        <div class="addinfo">
                            ...
                            <div class="form-group-info">
                                ...
                                <input id="genreInputs" required type="text" name="gener"
