                                ...
                                <div class="king-info">
                                    ...
                                    <div class="fetch">
                                        <div class="Movie-Info">
                                            <h3>({{ $tv->title }}) تعديل ({{ $seasons->title }})  لمسلسل</h3>
                                            <hr>
                                            <div>
                                                <h6>رقم الموسم</h6>
                                        ...
                                        <div class="addmoviebtn mt-4">
                                            ...
                                            <button class="fetch-btn">تعديل الموسم</button>
...
<script>
    function addnewvideo(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('editSeason', $seasons->id) }}",
