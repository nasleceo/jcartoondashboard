                ...
                <div class="fetch">
                    ...
                    <form id="fetchimdbform" enctype="multipart/form-data" onsubmit="getDatafromimdb(event)" method="POST">
                        ...
                        <div class="form-group">
                            <input id="tmdbid" name="tmdbid" type="text" placeholder="ادخل رمز">
                        </div>
                ...
                <div>
                    ...
                    <div class="addinfo">
                        ...
                        <div class="form-group-info">
                            ...
                            <input class="nameinp" name="title" required type="text" placeholder="العنوان">
                        ...
                        <div class="m-title">
                            ...
                            <div class="fetch">
                                ...
                                <div class="form-group-info">
                                    ...
                                    <input type="text" name="poster" required id="posterlink" placeholder="البوتسر"
                                        class="record-poster">
                            ...
                            <div class="fetch">
                                ...
                                <div class="form-group-info">
                                    ...
                                    <input type="text" name="cover" required id="coverlink" placeholder="الغلاف"
                                        class="record-poster">
                    ...
                    <h3 class="kisatitle"><b>القصة</b></h2>
                        <div class="m-title mb-3">
                            ...
                            <div class="form-group-info">
                                ...
                                <textarea name="story" required id="text-desc" rows="5" value="ddd"></textarea>
                        ...
                        <div class="addinfo">
                            ...
                            <div class="form-group-info">
                                ...
                                <input id="year" required name="year" type="number" placeholder="السنة">
                                <h6 class="m-4"> السنة</h6>

                            </div>
                            <div class="form-group-info">

                                <input id="genreInputs" required type="text" name="gener" placeholder="التصنيف">
                        ...
                        <div class="top">
                            ...
                            <div class="fetch">
                                ...
                                <div class="wrapper">
                                    <button class="btn-fetch" type="submit">نشر</button>
        ...
        function getDatafromimdb(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    const dateString = obj.first_air_date;
