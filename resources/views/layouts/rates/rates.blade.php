                ...
                <div class="king-info">
                    ...
                    <div class="fetch">
                        ...
                        <div class="mt-3">
                            ...
                            <input required type="text" name="jcartoonrate" class="record-tmdb_id"
                                value="{{ old('jcartoonrate') }}">
                        ...
                        <div class="addmoviebtn mt-4">
                            ...
                            <button class="fetch-btn">إضافة تقيم</button>
            ...
            <tbody>
                ...
                @foreach ($rates as $item)
                    <tr>
                        ...
                        <td class="mytitle" >{{ $item->jcartoonrate }}</td>
                        <td class="warning">{{ $item->cartoon->title }}</td>
...
function Deletvid(e, id) {
        ...
        swal({
                title: "هل انت متأكد",
                text: "ستتمكن من حدف التقيم إدا ضغطت علي زر حدف",
                icon: "warning",
                buttons: true,
                buttons: ["إلغاء", "! حدف"],
                dangerMode: true,
