                                ...
                                <div class="king-info">
                                    ...
                                    <div class="fetch">
                                        <div class="Movie-Info">
                                            <h3>({{ $tv->title }}) تعديل فيديو للفيلم</h3>
                                            <hr>
                                        ...
                                        <input hidden type="text" name="id" class="record-tmdb_id"
                                        value="{{ $tv->id }}">
                                        <div class="mt-3">
                                            <h6>المصدر</h6>
                                        ...
                                        <div class="addmoviebtn mt-4">
                                            ...
                                            <button class="fetch-btn">تعديل الفيديو</button>
...
<script>
    function addnewvideo(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('Editmovievid', $video->id) }}",
