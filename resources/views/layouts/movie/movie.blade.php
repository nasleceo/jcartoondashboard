...
<main>
    ...
    <div class="ads">
        <div class="wrapper">
            <a href="/movie/addmovie" class="btn-upgrade">إضافة فيلم</a>
            <p>أضف ماتريد من الأفلام </p>
        </div>
    </div>
            ...
            <tbody>
                ...
                @foreach ($movie as $item)
                    ...
                    <tr>
                        ...
                        <td class="warning">{{count($item->rate)}}</td>
                        <td class="warning">{{count($item->episdoes)}}</td>
                        <td>
                            <div class="menu">
                                <i class='bx bx-dots-horizontal-rounded icon'></i>
                                <ul class="menu-link">
                                    <li><a href="movie/edit/{{$item['id']}}">تعديل</a></li>
                                    <li><a href="movie/videos/{{$item['id']}}">الفيديوهات</a></li>
...
<script>
    function Deletvid(e, id) {
        ...
        swal({
                title: "هل انت متأكد",
                text: "ستتمكن من حدف الفيلم إدا ضغطت علي زر حدف",
                icon: "warning",
                buttons: true,
                buttons: ["إلغاء", "! حدف"],
                dangerMode: true,
