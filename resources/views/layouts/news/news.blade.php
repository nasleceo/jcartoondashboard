                                ...
                                <div class="king-info">
                                    ...
                                    <div class="fetch">
                                        ...
                                        <div class="addmoviebtn mt-4">
                                            ...
                                            <button class="fetch-btn">إضافة الخبر</button>
                                ...
                                <table id="tvt" class="hover">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($news as $item)
                                            <tr>
                                                <td  ><div class="warning">{{ $item['title'] }}</div></td>
                                                <td class="lkabarnas">{{ $item['text']  }}</td>
                                                <td class="warning">{{ $item['news_Time'] }}</td>
                                                ...
                                                <td>
                                                    <div class="menu">
                                                        ...
                                                        <ul class="menu-link">
                                                            <li><a
                                                                    href="/news/edit/{{ $item['id'] }}">تعديل</a>
                                                            </li>
                                                            <li>
...
<script>
    ...
    function Deletvid(e, id) {
        ...
        swal({
                title: "هل انت متأكد",
                text: "ستتمكن من حدف الخبر إدا ضغطت علي زر حدف",
                icon: "warning",
                buttons: true,
                buttons: ["إلغاء", "! حدف"],
                dangerMode: true,
